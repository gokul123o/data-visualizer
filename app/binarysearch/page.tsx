...
export default function Home() {
    ...
    return (
        ...
        <AlgorithmCard
                ...
                description="Binary search is a divide-and-conquer algorithm that searches for a target value within a sorted array."
                steps={[
                    "Start with the middle element.",
                    "If the target equals the middle, return the index.",
                    "If target < middle, repeat on the left half.",
                    "If target > middle, repeat on the right half.",
                ]}
