...
export default function Index() {
  ...
  return (
    ...
    <div className="">
        ...
        <img src="img-1.jpg" alt="" width={700} height={200} className="p-6"/>
        ...
        <h3 className="p-6 text-2xl text-gray-700 font-bold">Choose a data structure to learn:</h3>
        <ul className="space-y-2">
          {dataStructures.map((data)=>
          (
            <li key={data} className="gap-2 text-[20px] p-2 mx-[50px]">
